...
Generated: 2026-05-18 01:27 UTC
...
| PostHog | Warm Build | 0m 19s | 0m 14s | near tie | 6.13 GB less (48.81%) |
| Storybook | Cold Build | 3m 26s | 3m 35s | 4% slower | 44.66 MB more (6.12%) |
...
| gRPC | Cold Build | 25m 7s | 37m 1s | 47% slower | 648.07 MB more (611.13%) |
...
| PostHog | Commit Build | 16m 30s | 10m 57s | 34% faster | 3.97 GB less (39.22%) |
...
| gRPC | Commit Build | 0m 54s | 0m 56s | near tie | 10.68 MB more (1.36%) |
...
- use `data/snapshot/` as the public source of truth
- name the lane and metric behind the claim
- keep slower runs, higher storage, and investigation-only samples explicit
