...
Generated: 2026-05-03 12:49 UTC
...
| PostHog | Warm | 0m 47s | 0m 13s | 73% faster | 6.93 GB (53.31%) | cold, run total faster; 3 paired samples |
...
| Zed | Run Total | 52m 55s | 52m 9s | near tie | 73.95 MB (2.59%) | warm slower; 3 paired samples |
...
| PostHog | First Build | 16m 35s | 12m 44s | reseeded 2/3 | 8.99 GB (60.68%) | 3 paired samples; BC reseeded 2/3; Rolling Docker reseeds are first-build investigation samples, not steady-state parity. |
...
| Zed | Run Total | 35m 19s | 34m 34s | near tie | 7.01 GB (67.15%) | 3 paired samples |
