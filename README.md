...
Generated: 2026-05-02 12:49 UTC
...
| PostHog | Cold | 22m 58s | 15m 6s | 34% faster | 6.29 GB (50.88%) | run total faster; 3 paired samples |
...
| PostHog | First Build | 15m 25s | 10m 58s | reseeded 3/3 | 5.15 GB (46.58%) | 3 paired samples; BC reseeded 3/3; Rolling Docker reseeds are first-build investigation samples, not steady-state parity. |
