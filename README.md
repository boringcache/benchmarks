...
| PostHog | Cold Build | 19m 2s | 15m 46s | 17% faster | 7.78 GB (54.74%) | workflow total faster; BC storage: remote CAS 6.43 GB; 3 paired samples |
...
| PostHog | Commit Build | 23m 47s | 9m 39s | 59% faster | 5.66 GB (46.84%) | workflow total faster; BC storage: remote CAS 6.43 GB; 3 paired samples |
