...
Generated: 2026-05-03 16:49 UTC
...
| PostHog | Cold | 21m 24s | 15m 24s | 28% faster | 6.34 GB (51.07%) | run total faster; 3 paired samples |
...
| Zed | Run Total | 53m 56s | 52m 20s | near tie | 73.92 MB (2.59%) | warm slower; 3 paired samples |
...
| PostHog | First Build | 15m 37s | 10m 56s | reseeded 3/3 | 4.73 GB (44.11%) | 3 paired samples; BC reseeded 3/3; Rolling Docker reseeds are first-build investigation samples, not steady-state parity. |
...
| Zed | Run Total | 34m 31s | 32m 59s | 4% faster | 7.18 GB (65.05%) | 3 paired samples |
