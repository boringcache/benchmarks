...
| PostHog | Run Total | 24m 3s | 15m 48s | 34% faster | 8.17 GB (57.39%) | cold faster; 3 paired samples |
...
| PostHog | First Build | 17m 9s | 11m 23s | reseeded 3/3 | 5.10 GB (46.38%) | 3 paired samples; BC reseeded 3/3; Rolling Docker reseeds are first-build investigation samples, not steady-state parity. |
