...
Generated: 2026-05-14 09:24 UTC
...
| Immich | Cold Build | 5m 21s | 4m 53s | 9% faster | 7.31 GB (76.86%) | workflow total faster; 3 paired samples |
| Mastodon | Cold Build | 10m 44s | 9m 5s | 15% faster | 9.34 GB (90.14%) | workflow total faster; 3 paired samples |
| PostHog | Cold Build | 25m 0s | 15m 38s | 37% faster | 7.56 GB (54.17%) | workflow total faster; 3 paired samples |
| Storybook | Warm Build | 0m 51s | 0m 42s | 18% faster | 43.15 MB more (-5.91%) | cold, workflow total slower; BC used more storage; 3 paired samples |
...
| Zed | Cold Build | 47m 20s | 47m 38s | near tie | 1.30 GB (46.74%) | warm slower; 3 paired samples |
| n8n | Workflow Total | 6m 16s | 6m 3s | 3% faster | 52.91 MB more (-7.06%) | warm slower; BC used more storage; 3 paired samples |
...
| PostHog | Commit Build | 18m 10s | 12m 14s | 33% faster | 6.99 GB (52.96%) | workflow total faster; 3 paired samples |
| Storybook | Commit Build | 5m 1s | 4m 12s | 16% faster | 1.19 GB (61.07%) | workflow total faster; 3 paired samples |
...
| Zed | Commit Build | 32m 42s | 36m 20s | 11% slower | 4.53 GB (53.66%) | workflow total slower; 3 paired samples |
| n8n | Commit Build | 3m 13s | 4m 34s | 42% slower | 2.59 GB (76.69%) | workflow total slower; 3 paired samples |
