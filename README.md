...
Generated: 2026-05-04 20:56 UTC
...
| PostHog | Cold | 21m 42s | 15m 40s | 28% faster | 6.12 GB (50.12%) | run total faster; 3 paired samples |
...
| Zed | Run Total | 52m 56s | 52m 13s | near tie | 74.20 MB (2.6%) | warm slower; 3 paired samples |
...
| PostHog | First Build | 17m 7s | 11m 24s | reseeded 3/3 | 6.16 GB (51.3%) | 3 paired samples; BC reseeded 3/3; Rolling Docker reseeds are first-build investigation samples, not steady-state parity. |
...
| Zed | Run Total | 32m 32s | 32m 28s | near tie | 3.36 GB more (-55.52%) | BC used more storage; 3 paired samples |
