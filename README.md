...
| PostHog | Cold | 27m 19s | 14m 44s | 46% faster | 5.60 GB (47.98%) | run total faster; 3 paired samples |
...
| Zed | Cold | 48m 57s | 49m 18s | near tie | 73.85 MB (2.59%) | warm slower; 3 paired samples |
...
| PostHog | First Build | 19m 6s | 13m 5s | reseeded 2/3 | 8.67 GB (59.14%) | 3 paired samples; BC reseeded 2/3; Rolling Docker reseeds are first-build investigation samples, not steady-state parity. |
...
| Zed | Cold | 31m 35s | 35m 20s | 12% slower | 5.41 GB (47.14%) | run total slower; 3 paired samples |
