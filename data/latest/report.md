...
Generated: 2026-04-29 20:51 UTC
...
| gRPC | Warm | 36m 36s | 4m 25s | 88% faster | 743.91 MB more (-457.84%) | cold slower; BC used more storage; 3 paired samples |
...
| PostHog | First Build | 20m 49s | 13m 24s | reseeded 3/3 | 7.44 GB (56.0%) | 3 paired samples; BC reseeded 3/3; Rolling Docker reseeds are first-build investigation samples, not steady-state parity. |
| OpenTelemetry Java | Cold | 1m 41s | 5m 9s | 206% slower | 1.84 GB (70.46%) | run total slower; 3 paired samples |
| Spring AI | Cold | 1m 43s | 4m 46s | 178% slower | 2.05 GB (64.96%) | run total slower; 3 paired samples |
| gRPC | Cold | 33m 22s | 26m 7s | 22% faster | — | run total faster; storage unavailable; 3 paired samples |
| Zed | Run Total | 27m 13s | 27m 2s | near tie | 8.80 GB (92.75%) | cold slower; 3 paired samples |
| n8n | Run Total | 5m 26s | 4m 0s | 26% faster | 6.08 GB (89.68%) | cold faster; 3 paired samples |
