...
| PostHog | First Build | 16m 36s | 14m 55s | reseeded 3/3 | 3.95 GB (40.44%) | 3 paired samples; BC reseeded 3/3; Rolling Docker reseeds are first-build investigation samples, not steady-state parity. |
...
| gRPC | Cold | 34m 0s | 33m 40s | near tie | 581.80 MB more (-179.04%) | BC used more storage; 3 paired samples |
| Zed | Cold | 23m 42s | 39m 43s | 68% slower | 6.62 GB (90.59%) | run total slower; 3 paired samples |
