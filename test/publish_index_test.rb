...
class PublishIndexTest < Minitest::Test
  ...
  def test_native_docker_artifact_keeps_docker_oci_adapter
  ...
  def test_provider_workflows_include_standard_and_optional_providers
    ...
    assert_equal(
      {
        ...
        "boringcache-mountcache" => "posthog-benchmark.yml"
      },
    ...
    assert_includes lane_artifact_names(benchmark_id: "posthog", strategy: "boringcache-mountcache", lane: "rolling"),
